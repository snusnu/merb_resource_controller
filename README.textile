...
expect, no? Additionally, you will probably want to override the redirection targets, since @merb_resource_controller@
currently isn't smart enough to redirect to sensible defaults. I will work on that, though.
...
# Reasonable redirection targets for singleton resources
