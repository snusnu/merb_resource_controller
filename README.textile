...
class Application < Merb::Controller
  ...
  # This will give you the 'enable_identity_map' class method
  ...
  #
  # Of course, feel free to enable the identity map on single
  # controllers instead of Application controller as shown in this example
